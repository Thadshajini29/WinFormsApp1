...
namespace WinFormsApp1
{
    public partial class Frmdbshow : Form
    {
        ...
        private void Frmdbshow_Load(object sender, EventArgs e)
        {
            ...
            rdoMale.Checked = dr["gender"].ToString() == "M";
            rdoFemale.Checked = dr["gender"].ToString() == "F";
            ...
            cmb_grade.Text = dr["grade_id"].ToString();
            cmbhouse.Text = dr["house_id"].ToString();
            cmb_familyid.Text = dr["family_id"].ToString();
